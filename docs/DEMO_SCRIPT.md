...
| 3 | Watchlist (13 deals), then the broker-vs-DealSieve table and the frontier card for one deal | We got thirteen packages this week. Five died on structure. Six are watching with a stored price. One is near the line. Look at this example package. It advertised one point five five million for an eight percent return. My math showed a six point four percent return. DealSieve logged a pass and stored a yes at about one point two nine million. |
